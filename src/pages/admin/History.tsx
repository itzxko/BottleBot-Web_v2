...
const History = () => {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen bg-[#EDEDED] flex flex-col items-center justify-start p-6 font-DM gap-6">
        <div className="flex flex-row items-center justify-center p-2 rounded-full bg-white">
          {pageType === "rewards" ? (
            <div className="flex items-center justify-center px-4 py-2 bg-gradient-to-tr from-[#466600] to-[#699900] rounded-full">
